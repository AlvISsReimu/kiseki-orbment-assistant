...
const Main = () => {
  ...
  const theme = useMemo(() => (gc.themeMode === 'dark' ? darkTheme : lightTheme), [gc.themeMode]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <FormControl fullWidth>
          ...
          >
            <MenuItem value={Language.ZH_CN}>{translations.chinese[gc.language]}</MenuItem>
            <MenuItem value={Language.JA}>{translations.japanese[gc.language]}</MenuItem>
            <MenuItem value={Language.EN}>{translations.english[gc.language]}</MenuItem>
          </Select>
        </FormControl>
        <ToggleButtonGroup
          value={gc.themeMode}
